...
<html lang="en">
  <head>
    ...
    <script type="text/javascript">
        ...
        function cifrar(){
            var input_pass = document.getElementByName("contra");
              ...
              <div class="form-group">
                 ...
                 <div class="form-group has-feedback"> <!----- username -------------->
                  ...
                  <div class="row">
                      ...
                      <div class="col-xs-12">
                          <button type="submit" id="boton" name="boton" class="btn btn-green btn-block btn-flat" onclick="cifrar()">Ingresar</button>
                      </div>
                  </div>
                </form>
              </div>
